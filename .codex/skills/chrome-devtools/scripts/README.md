...
cd $SKILL_DIR/.codex/skills/chrome-devtools/scripts
...
**Automatic Compression**: Screenshots >5MB are automatically compressed using ImageMagick to ensure compatibility with Gemini API and Codex. Install ImageMagick for this feature:
