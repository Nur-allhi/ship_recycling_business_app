        ...
        <CardContent className="space-y-4 pt-4 px-4 sm:px-6" ref={containerRef}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="amount-ledger" type="number" step="0.01" {...register('amount')} placeholder="0.00" {...registerForFocus('amount')} />
              ...
              {contact_id === 'new' && (
                <div className="flex items-end gap-2 pt-2 animate-fade-in">
                  <div className="flex-grow space-y-1">
                    ...
                    <Input {...register('newContact')} placeholder={`Enter new ${currentLedgerContactType.toLowerCase()} name`} {...registerForFocus('newContact')}/>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-2">
            ...
            <Input id="description-ap" {...register('description')} placeholder="e.g., Raw materials from X vendor" {...registerForFocus('description')}/>
