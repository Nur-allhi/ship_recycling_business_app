        ...
        <div className="grid grid-cols-3 gap-4 my-4 p-4 rounded-lg bg-muted/50">
            <div className="text-center">
             ...
             <div className="text-center">
                ...
                <p className="text-xl font-bold font-mono text-green-600 dark:text-green-400">{formatCurrency(totalCredit)}</p>
            </div>
             <div className="text-center">
                <p className="text-sm text-muted-foreground">Balance Due</p>
                <p className="text-xl font-bold font-mono text-red-600 dark:text-red-400">{formatCurrency(finalBalance)}</p>
            </div>
        </div>
                        ...
                        return combinedHistory.map((item, index) => {
                            ...
                            return (
                                <TableRow key={item.id + index}>
                                    ...
                                    <TableCell className="text-right font-mono text-red-600 dark:text-red-400">{debit > 0 ? formatCurrency(debit) : '-'}</TableCell>
                                    <TableCell className="text-right font-mono text-green-600 dark:text-green-400">{credit > 0 ? formatCurrency(credit) : '-'}</TableCell>
